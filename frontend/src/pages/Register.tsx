          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                className="flex h-10 w-full rounded-lg border border-input bg-background pl-9 pr-3 py-2 text-sm placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 focus:ring-offset-background"
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                className="flex h-10 w-full rounded-lg border border-input bg-background pl-9 pr-10 py-2 text-sm placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 focus:ring-offset-background"
                placeholder="••••••••"
              />
              <button
                type="button"
            ...
            {showChecks && (
              <motion.div
                initial={{ opacity: 0, height: 0 }}
                animate={{ opacity: 1, height: 'auto' }}
                className="rounded-lg border border-border bg-muted/50 p-3 space-y-1.5 mt-2"
              >
                {passwordChecks.map((check) => {
                  ...
                  return (
                    <div key={check.label} className="flex items-center gap-2 text-xs">
                      <CheckCircle2
                        className={`h-4 w-4 transition-colors ${passed ? 'text-success' : 'text-muted-foreground'}`}
                      />
